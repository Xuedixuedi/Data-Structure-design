...
Find if the vertex's is a zero degree：
...
| Mon            | Tues     | Wed            | Thri     | Fri            |
| -------------- | -------- | -------------- | -------- | -------------- |
| 计算机组成原理 | 英语     | 计算机组成原理 | 算法设计 | 计算机组成原理 |
| 计算机组成原理 | 英语     | 计算机组成原理 | 算法设计 | 计算机组成原理 |
| 汇编语言       | 英语     |                | 汇编语言 | 英语           |
| 汇编语言       |          |                | 汇编语言 | 英语           |
| 算法设计       | 微机原理 |                |          |                |
...
| Mon        | Tues         | Wed  | Thri       | Fri          |
| ---------- | ------------ | ---- | ---------- | ------------ |
| 编译原理   | 程序设计基础 | 英语 | 编译原理   | 操作系统原理 |
| 编译原理   | 程序设计基础 | 英语 | 编译原理   | 操作系统原理 |
| 编译原理   | 程序设计基础 | 英语 |            | 英语         |
|            |              |      |            | 英语         |
| 数据库原理 | 操作系统原理 |      | 数据库原理 | 单片机应用   |
| 数据库原理 | 操作系统原理 |      | 数据库原理 | 单片机应用   |
| 数据库原理 |              |      | 数据库原理 | 单片机应用   |
|            |              |      |            |              |
|            |              |      |            |              |
...
| Mon          | Tues        | Wed  | Thri         | Fri         |
| ------------ | ----------- | ---- | ------------ | ----------- |
| PowerBuilder | ASP程序设计 |      | PowerBuilder | ASP程序设计 |
| PowerBuilder | ASP程序设计 |      | PowerBuilder | ASP程序设计 |
| PowerBuilder | ASP程序设计 |      | 数据结构     | JSP程序设计 |
| 数据结构     |             |      | 英语         | JSP程序设计 |
| 英语         | JSP程序设计 |      | VC++         |             |
| 英语         | JSP程序设计 |      | VC++         |             |
| 英语         | JSP程序设计 |      | VC++         |             |
...
| Mon    | Tues       | Wed  | Thri   | Fri        |
| ------ | ---------- | ---- | ------ | ---------- |
| VB.net | Delphi     |      | VB.net | Delphi     |
| VB.net | Delphi     |      | VB.net | Delphi     |
| VB.net | Delphi     |      | 英语   |            |
|        |            |      | 英语   |            |
| 英语   | C++Builder |      |        | C++Builder |
| 英语   | C++Builder |      |        | C++Builder |
| 英语   |            |      |        | C++Builder |
|        |            |      |        |            |
|        |            |      |        |            |
